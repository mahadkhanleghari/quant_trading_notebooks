...
-   **Market Microstructure**
    ...
    [Explore Research](projects_overview.md#market-microstructure)
...
-   **Cross-Asset Alpha**
    ...
    [View Alpha Engine](cross_asset_alpha_engine/index.md)
...
-   **Regime Detection**
    ...
    [Learn Methods](methodology/statistical_methods.md)
...
-   **Risk Management**
    ...
    [Risk Framework](results/risk_analysis.md)
...
[View Methodology](cross_asset_alpha_engine/methodology.md){ .md-button }
...
**Research Highlights:**
- VWAP Half-Life: 18.3 minutes
- Significant Minutes: 337/1440
- Regime Detection: 4 distinct states

[View Analysis](crypto_microstructure_analysis_files/crypto_microstructure_analysis.md){ .md-button .md-button--primary }
[Browse All Projects](projects_overview.md){ .md-button }
...
[Browse All Research](projects_overview.md){ .md-button .md-button--primary .md-button--stretch }
